...
public class MainActivity extends DrawerActivity {
    ...
    public static final String AUTHORITY = "com.noteshareapp.bgSync.provider";
    // An account type, in the form of a domain name
    public static final String ACCOUNT_TYPE = "noteshareapp.com";
    // The account name
    public static final String ACCOUNT = "noteshareapp";
    // Instance fields
    Account mAccount;
